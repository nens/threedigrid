...
def test_add_or_update_datasets_new_data(hdf5_file, np_array_dict):
    """Add some new data to an hdf5 file"""
    h5py_group = hdf5_file.create_group('mygroup')
...
def test_add_or_update_datasets_existing_data(hdf5_file, np_array_dict):
